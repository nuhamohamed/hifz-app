 ...
 * void. It used to call ensurePermissions() and throw the answer away, so a
 * refusal produced a reminder that was queued, never delivered, and never
 * reported: the app believed reminders were on and the person never saw one.
 *
 * Cancels existing notifications first, so calling it repeatedly cannot stack
 * duplicates.
 *
