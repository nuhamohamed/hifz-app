const TASHKEEL_PATTERN = /[\u0610-\u061A\u064B-\u065F]/g;
...
/** Uthmanic superscript alef and similar orthographic marks (not in tashkeel ranges). */
const ORTHOGRAPHIC_MARKS_PATTERN = /\u0670/g;
...
export function normalizeArabic(text) {
  return removeOrthographicVowelExtensions(
    text
      ...
      .replace(ORTHOGRAPHIC_MARKS_PATTERN, '')
