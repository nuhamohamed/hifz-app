...
export default function OnboardingGenderMockup({ route, navigation }) {
  ...
  const handleContinue = () => {
    ...
    navigation.navigate('MockupOnboardingNotifications', { name });
  };
...
const styles = StyleSheet.create({
  ...
  cards: { flexDirection: 'row', paddingHorizontal: S.lg, gap: 12, marginTop: S.md },
  card: {
    flex: 1, backgroundColor: C.white, borderRadius: 16, padding: S.md,
    borderWidth: 1.5, borderColor: C.cardBorder, alignItems: 'flex-start', minHeight: 130,
  },
  cardSelected: { borderColor: C.cobalt, backgroundColor: C.cobaltDim },
  cardIcon: { fontSize: 24, marginBottom: S.sm, color: C.cobalt },
  cardLabel: { fontFamily: F.semiBold, fontSize: 18, color: C.navy, marginBottom: S.xs },
  cardLabelSelected: { color: C.cobalt },
  cardDesc: { fontFamily: F.regular, fontSize: 12, color: C.navyMid, lineHeight: 17, marginTop: 4 },
  note: {
    flexDirection: 'row', marginHorizontal: S.lg, marginTop: S.md,
    backgroundColor: C.goldLight, borderRadius: 12, padding: S.md, gap: 10, alignItems: 'flex-start',
  },
  noteIcon: { fontSize: 14, color: C.gold, marginTop: 2 },
  noteText: { flex: 1, fontFamily: F.regular, fontSize: 13, color: C.navy, lineHeight: 19 },
  backBtn: { paddingBottom: S.sm, alignSelf: 'flex-start' },
  backBtnText: { fontFamily: F.medium, fontSize: 14, color: C.navyMid },
  footer: { marginTop: 'auto', paddingHorizontal: S.lg, paddingBottom: 48, paddingTop: S.md },
  primaryBtn: { backgroundColor: C.cobalt, borderRadius: 14, paddingVertical: 17, alignItems: 'center', marginBottom: 4 },
  primaryBtnDisabled: { opacity: 0.4 },
  primaryBtnText: { fontFamily: F.semiBold, fontSize: 17, color: C.white },
  skipBtn: { paddingVertical: 14, alignItems: 'center' },
  skipBtnText: { fontFamily: F.medium, fontSize: 15, color: C.navyMid },
});
